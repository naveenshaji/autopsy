...
must cite at least one supplied context; if none supports the answer, the model
must abstain. Abstentions may cite case-local context when it explains why the
