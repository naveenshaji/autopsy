...
def build_parser(
    ...
    *,
    ...
    shared_server_parser.add_argument("--idempotency-key", help="With shared-server publish, archive, restore, restore-version, or restore-apply-snapshot, reuse this client request key for safe manual retry. Generated automatically when omitted.")
